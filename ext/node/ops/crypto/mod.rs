...
#[op2(fast)]
pub fn op_node_hash_update(#[cppgc] hasher: &digest::Hasher, #[buffer] data: &[u8]) -> bool {
    hasher.update(data)
}

#[op2(fast)]
pub fn op_node_hash_update_str(#[cppgc] hasher: &digest::Hasher, #[string] data: &str) -> bool {
    hasher.update(data.as_bytes())
}

#[op2]
#[buffer]
pub fn op_node_hash_digest(#[cppgc] hasher: &digest::Hasher) -> Option<Box<[u8]>> {
    hasher.digest()
}

#[op2]
#[string]
pub fn op_node_hash_digest_hex(#[cppgc] hasher: &digest::Hasher) -> Option<String> {
...
pub fn op_node_verify(
    ...
    match key_type {
        "rsa" => {
            ...
            // See https://github.com/openssl/openssl/blob/af82623d32962b3eff5b0f0b0dedec5eb730b231/crypto/rsa/rsa_sign.c#L285
            if digest_type == "md5-sha1" {
                let verifying_key = VerifyingKey::<md5_sha1::Md5Sha1>::new_unprefixed(key);
